...
public class ProductServer {
    ...
    public class SocketClient {
        ...
        //필드
        private Socket socketprivate DataInputStream dis;
    ...
    public void receive() {
        threadPool.execute(() -> {
                    ...
                    public void list(JSONObject request) throws IOException {
                        ...
                        for(Product p : products) {JSONObject product = new JSONObject();
                    ...
                    public void update(JSONObject request) throws IOException {
                        ...
                        for(int i=0; i<products.size(); i++) {
                            ...
                            if(product.getNo() == no) {
                                product.setName(data.getString("name"));
                                product.setPrice(data.getInt("price"));product.setStock(data.getInt("stock"));
                            }
                        }
                        //응답 보내기
...
//메소드:    메인public static void main(String[] args) {
